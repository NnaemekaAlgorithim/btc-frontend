  ...
  return (
    <main className="flex flex-col min-h-screen px-6 pt-14 pb-10" style={{ background: "#09090B" }}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 fade-up-2">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              style={{
                background: "#111114",
                borderColor: errors.phone_number ? "#EF4444" : "rgba(212,175,55,0.3)",
                color: "#F8F8F8",
                outline: "none",
              }}
              required
        ...
        {/* Referral code — pre-filled if ?ref= is in URL */}
        <GoldInput
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            style={{
              background: form.agreed_to_terms ? "#D4AF37" : "transparent",
      ...
      <p className="text-center mt-6 text-sm fade-up-3" style={{ color: "#52525B" }}>
        ...
        <Link href="/login" style={{ color: "#D4AF37" }} className="font-semibold">
          Sign in
        </Link>
      </p>
    </main>
